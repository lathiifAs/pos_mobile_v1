...
/// data : [{"array_akun":[{"user_id":202107271,"user_name":"akungudang1","user_st":"1","role_id":3,"nama":"akun gudang 1","no_hp":"2147483647","alamat_lengkap":"indramayu karangsong"}]}]

class ModelWarehoseAccount {
  bool? _notifSt;
  String? _notifMsg;
  List<Data>? _data;
  ...
  ModelWarehoseAccount.fromJson(dynamic json) {
...
/// array_akun : [{"user_id":202107271,"user_name":"akungudang1","user_st":"1","role_id":3,"nama":"akun gudang 1","no_hp":"2147483647","alamat_lengkap":"indramayu karangsong"}]
